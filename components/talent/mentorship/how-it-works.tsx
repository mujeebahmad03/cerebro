...
import { ClipboardCheck, CheckCircle, CalendarDays, Handshake } from 'lucide-react'
...
const steps = [
  ...
  {
    title: 'Schedule preferred Mentorship Package',
    description: 'Explore our range of professional mentorship packages which help in your learning journey',
    icon: CalendarDays,
  },
  {
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300">
            A Step-by-Step Guide to Cerebro Mentorship
          </p>
        </motion.div>
